...
from student_management_app.models import Students, Courses, Subjects, CustomUser, Attendance , AttendanceReport , FeedBackStudent , LeaveReportStudent , SessionYearModel
